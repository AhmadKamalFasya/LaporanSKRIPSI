  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <a href="<?php echo BASE_URL."index.php?page=my_profile&module=barang&action=delete&barang_id=$row[barang_id]" ?>" class="btn btn-primary btn-sm-edit">Hapus</a></td>
                  </tr>
                  <?php $no++; ?>
                </tbody>
              <?php } ?>
        ...
        <hr>
         <center><h3>DAFTAR BARANG YANG KURANG LAKU </h3></center>
        <hr>
